...
class simSEIRHVD:
    ...
    def __init__(self,beta = 0.19, mu =2.6,inputarray = definputarray,B=221,D=26,V=758,I_act0=12642,R=0,Htot=None,Vtot=None,H_cr=0,H0=1720,Hmax=4000,Vmax=2000,expinfection=0,SeroPrevFactor=1,population = 1000000, intgr = 0,I_as_ac =0, I_mi_ac = 0, I_se_ac = 0, I_cr_ac = 0,H_crD = 0, VD=0,I_crD=0,I_seD=0):
        ...
        self.I_act0 = I_act0
        self.R  = R
        self.H_cr = H_cr # Hospitalizados a la espera de un ventilador dia 0
    ...
    def simulate(self):
        ...
        if num_cores >=24:
            ...
            for i in range(len(self.inputarray)):
                self.sims.append(self.sim_run(self.inputarray[i,0],self.inputarray[i,1],self.inputarray[i,2],self.inputarray[i,3],self.inputarray[i,4],self.inputarray[i,5],self.inputarray[i,6]))
...
class SEIRHUDV :  
    ...
    def setparams(self):
        ...
        self.psymi = 0.916#0.78 # Transicion de Expuesto Sintomatico a Infectado Mild
        self.tsymi = 5.0

        self.psycr = 0.02777#0.8 # Transicion de Expuesto Sintomatico a Infectado critico 0.05
        self.tsycr = 3.0 #5

        self.psyse = 0.05555#0.14 # Transicion de Expuesto Sintomatico a Infectado Severo 0.017
        self.tsyse = 3.0 #5
        ...
        self.pVout = 0.5#75 # Mejora de ventilado hospitalizado, transita a Hout
        self.tVout = 15.0

        self.pVD = 0.5#25 # Muerte de ventilado
        self.tVD = 15.0
    ...
    def setinitvalues(self):
        ...
        self.res=1 
        self.muS=self.mu        
        self.H_incr = np.poly1d(34)
        self.H_incr2 = 0
        self.H_incr3 = 0
        self.V_incr = np.poly1d(17)
        self.V_incr2 = 0
        self.V_incr3 = 0
        self.Vc0 = 1029
        self.Hc0 = 1980
