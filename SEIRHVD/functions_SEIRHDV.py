...
class SEIRHVD_DA:
    ...
    #       Infectados Activos       #
    # ------------------------------ #
    def plotactivos(self,enddate =  datetime(2020,7,30),days=0, reales= True,ylim = 0,norm=1,scalefactor = False,legend=True):
        # -------- #
        #   Time   #
        # -------- #
        if days == 0:
