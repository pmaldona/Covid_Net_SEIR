...
To Do:
    - Permitir ejecución remota desde el cluster:
        0. Ejecutar el código en el cluster
        1. Crear funciones en el backend que llamen a las funciones del simulador. Deben pasar:        
            - parámetros
            - Cuarentenas
            - Opcional de tasas
        2. Crear funcion que se comunique con el backend (como shusha?)
...
class SEIRHVD_DA:
    ...
    #def addscenario(self,tsim,max_mov,rem_mov,qp,iqt,fqt,movfunct):        
