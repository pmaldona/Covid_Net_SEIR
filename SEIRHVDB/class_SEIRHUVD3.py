...
class simSEIRHVD:
    ...
    def sim_run(self,tsim,max_mov,rem_mov,qp,iqt=0,fqt = 300,movfunct = 0, intgr = 0):       
    ...
    def simulate(self,intgr=0):
        ...
        self.sims=Parallel(n_jobs=num_cores, verbose=50)(delayed(self.sim_run)(self.inputarray[i,0],self.inputarray[i,1],self.inputarray[i,2],self.inputarray[i,3],self.inputarray[i,4],self.inputarray[i,5],self.inputarray[i,6],intgr) for i in range(self.inputarray.shape[0]))
        self.simulated = True
        return(self.sims)
