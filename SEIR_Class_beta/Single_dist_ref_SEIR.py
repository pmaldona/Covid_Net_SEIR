...
def ref_sim_cons(state,comuna,mov=0.2,qp=0,tsim = 300,tci=None,movfunct='sawtooth'):
    # Region, comuna, movilidad durante cuarentena, periodo cuarenetena, tiempo simulacion, tiempo inicial cuarentena
    ...
    filename = 'ActivosAcumuladosAle.xlsx'
    cutcomuna = 'cut_2018_v03.xls'
    ...
    def opti(x):
        E0=0
        E0=x[3]*I0
        sol=pd.DataFrame(intger(S0,E0,I0,R0,min(tr),max(tr),h,x[0],x[1],x[2],mov,qp,None,movfunct))
        return(objective_funct(Ir,tr,sol.I,sol.t))
